...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.homepage         = 'https://github.com/ZanyZephyr/BlinkingLabel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'ZanyZephyr' => 'liyizhezhe@gmail.com' }
  s.source           = { :git => 'https://github.com/ZanyZephyr/BlinkingLabel.git', :tag => s.version.to_s }
